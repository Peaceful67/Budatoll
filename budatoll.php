...
function budatoll_scripts() {
    ...
    wp_enqueue_style('budatoll-style', plugins_url('css/budatoll.css', __FILE__), [], '1.2.18', false);
    ...
    wp_enqueue_script('budatoll-header-script', plugins_url('js/budatoll-header-script.js', __FILE__), array('jquery'), '2.88', false);
    ...
    switch ($post->post_name) {
        ...
        case 'alkalom-naptar':
            ...
            break;
        case 'edzesek-naptar':
            wp_enqueue_script('budatoll-trainings-script', plugins_url('js/trainings_calendar.js', __FILE__), array('jquery'), '2.93', true);
            break;
        case 'edzeseim-naptar':
            wp_enqueue_script('budatoll-my-trainings-script', plugins_url('js/my_trainings_calendar.js', __FILE__), array('jquery'), '2.93', true);
            break;
    }
