...
function budatoll_scripts() {
    ...
    wp_enqueue_script('budatoll-header-script', plugins_url('js/budatoll-header-script.js', __FILE__), array('jquery'), '2.74', false);
    ...
    switch ($post->post_name) {
        ...
        case 'alkalom-naptar':
            ...
            break;
        case 'edzesek-naptar':
            wp_enqueue_script('budatoll-trainings-script', plugins_url('js/trainings_calendar.js', __FILE__), array('jquery'), '2.75', true); 
            break;
        case 'edzeseim-naptar':
            wp_enqueue_script('budatoll-my-trainings-script', plugins_url('js/my_trainings_calendar.js', __FILE__), array('jquery'), '2.74', true);
            break;
    }
    wp_enqueue_script('budatoll-jquery-ui-script', plugins_url('jquery-ui/jquery-ui.js', __FILE__), array('jquery'), '1.3', false);
    wp_enqueue_script('budatoll-end-script', plugins_url('js/budatoll-end-script.js', __FILE__), array('jquery'), '1.4', true);
